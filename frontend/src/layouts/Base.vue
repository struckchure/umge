<template>
  <div class="pama-0">
    <aside class="overflow overflow-hide-scroll">
      <router-link :to="{ name: 'Home' }" title="UMGE">
      ...
      <div class="pama-0" v-if="is_admin == true">
        ...
        <router-link :to="{ name: 'AdminStores' }">
          <button>
        ...
        <router-link :to="{ name: 'AdminRiders' }">
          <button>
        ...
        <router-link :to="{ name: 'AdminRidersApplications' }">
          <button>
        ...
        <router-link :to="{ name: 'AdminLocations' }">
          <button>
      ...
      <div class="pama-0" v-if="is_staff == true">
        ...
        <router-link :to="{ name: 'RiderOrders' }">
          <button>
            <i class="fas fa-history"></i>
            <span>Orders</span>
          </button>
        ...
        <router-link :to="{ name: 'RiderTasks' }">
          <button>
        ...
        <router-link :to="{ name: 'RiderHistory' }">
          <button>
      ...
      <router-link v-if="is_authenticated == true" :to="{ name: 'Logout' }">
        <button>
          ...
          <div class="cart w-auto mx-1 md:mx-16">
            ...
            <div class="flex center">
              <router-link :to="{ name: 'Cart' }">
                <button
                  class="fntz-8 pa-1 flex-h-center flex-1 btn-small bg-red-500"
                >
